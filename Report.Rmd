...
```{r SAU_Landings_Data, eval = T, echo = F, warning =F, message = F, fig.height = 8, fig.width= 12, fig.cap= "Top 10 species by landings from the SAU dataset. Red bars represent species not present in the other category. White boxes represent the contribution of that speciest to the total country landing"}
...
```{r SAU_Subsistance_Landings, eval = T, echo = F, warning =F, message = F, fig.height = 10, fig.width= 8, fig.cap= "Top 10 subsistance species by landings from the SAU dataset."}
...
```{r SAU_Landings_Value, eval = T, echo = F, warning =F, message = F, fig.height = 12, fig.width= 10, fig.cap= "Top 10 species by economic value from the SAU dataset. Red bars represent species not included as top 10 most landed species. White boxes represent the contribution of that speciest to the total country value"}
...
```{r B_Trade, eval = T, echo = F, warning =F, message = F, fig.height=5, fig.width=5, fig.cap="Seafood and fish imports and exports from Brazil between 2014 to 2017 (Source: MDIC)"}
...
```{r Comercial_Plot, eval = T, echo = F, warning =F, message = F, fig.height=5, fig.width= 5, fig.cap= "Quantity of fish and seafood products commercialized per month in 2017 at CEAGESP market (Source: CEAGESP)"}
...
```{r IBGE_Consumption, eval = T, echo = F, warning =F, message = F, fig.height= 5, fig.width= 5, fig.cap= "Per capita consumption of protein types per region of Brazil (Source: IBGE)"}
...
```{r IBGE_Income, eval = T, echo = F, warning =F, message = F, fig.height = 5 , fig.width = 5, fig.cap= "Monthly per capta income by region of Brazil in 2014 (Source: IBGE)"}
...
```{r top 10 fisheries in terms of volume, eval = T, echo= FALSE, warning=FALSE}
## Landings
## Totals
...
```{r, eval = T,  echo= FALSE, fig.cap= 'Main fisheries in Chile in the last five years accordint to wild catch landings', fig.height=5,fig.width=6,}
top10_catch
```
...
```{r, eval = T,  echo= FALSE, fig.cap= 'Main fisheries in Chile in the last five years according to aquaculture harvests', fig.height=5,fig.width=6}
top10_harvest
```
