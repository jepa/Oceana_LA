...
International_D %>%
  ...
  kable(
    ...
    caption = "Summary of results. Database used: SOFIA-FAO"
  ) 
...
International_DM <- International_D %>% 
  group_by(Country,Comm.Name,Sci.Name.Fb) %>% 
  summarise_if(is.numeric,mean,na.rm=T)


corefx(
  Species = International_DM$Sci.Name.Fb,
  Country = International_DM$Country,
  Catch = International_DM$Capture,
  Dis = .2,
  DHC = International_DM$DHC_Use,
  PL = 0.2,
  AP = International_DM$Aquaculture,
  A_PL = 0.2,
  I_DHC = International_DM$Imports,
  Exp = International_DM$Exports,
  Result = "T",
  n = 2
)
