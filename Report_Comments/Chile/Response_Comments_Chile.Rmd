...
- **How we addressed this in the report?:** The report states that possible isssues when using the international data. However, we modified the text to make this point more clear, reflecting our conversation with Oceana Chile. We again highlight this issue in footnote nº 2.
