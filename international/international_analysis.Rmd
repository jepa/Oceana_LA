...
# Those that are in catch dataset but not on Catch datset
...
#### STILL NOT WORKING. THE DATASETS DONT MATCH...
...
# Looking for cuplicates
Clean_FAO_Data %>% 
  get_dupes()
# No duplicate combinations found of: Country, Comm.Name, Sci.Name.Fb, Year, Aquaculture, Capture, Exports, Imports
...
### For some reason Trades do not mach and are overestimated but when you remove duplicates they get UNDER estimated (big time)
